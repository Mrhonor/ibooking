...
insert into tbl_booking_status(seatId, startTime, endTime, stuNum,isEnd,status)
values (1,'2023-06-15 19:55', '2023-06-15 17:26', '01010101',0,0), --一个：自动签到提醒 签到成功后，十分钟内未签退违约提醒
       (1,'2023-05-28 15:00', '2023-05-28 01:40', '01010103',1,2), --违约不管
       (1,'2023-06-15 14:00', '2023-06-15 16:05', '01010103',1,1), --一个：自动签退违约提醒
       (2,'2023-06-15 14:59', '2023-06-16 01:00', '01010102',0,0); --一个：自动签到超时提醒，违约后记2 不看是否签退了
